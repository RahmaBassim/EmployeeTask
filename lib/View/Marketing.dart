...
class Marketing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:InputText(Input: "Marketing Team", Size: 15, TextColor: white,FontWeight: FontWeight.bold,),
                              ...
                              Row(
                                ...
                                children: [
                                  IconButton(onPressed: () async{
                                    FirebaseFirestore.instance.collection("Marketing").doc(snapshot.data!.docs[index].id).delete();
                                          ...
                                          actions: [
                                            TextButton(
                                                onPressed: () async{
                                                  ...
                                                  await FirebaseFirestore.instance.collection("Marketing")
                                                      .doc("$Edit").update(
                                                      {
                                                        "Name": Name.text,
                                                        "Age": Age.text,
